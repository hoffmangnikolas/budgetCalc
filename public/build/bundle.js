...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$4, 23, 12, 626);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file$4, 19, 16, 518);
    			attr_dev(button0, "class", "amount-btn");
    			add_location(button0, file$4, 18, 19, 443);
    			add_location(h2, file$4, 17, 8, 419);
    			attr_dev(div0, "class", "expense-info");
    			add_location(div0, file$4, 16, 4, 384);
    			attr_dev(i1, "class", "fas fa-pen");
    			add_location(i1, file$4, 28, 12, 812);
    			attr_dev(button1, "class", "expense-btn edit-btn");
    			add_location(button1, file$4, 27, 8, 720);
    			attr_dev(i2, "class", "fas fa-trash");
    			add_location(i2, file$4, 31, 12, 954);
    			attr_dev(button2, "class", "expense-btn delete-btn");
    			add_location(button2, file$4, 30, 8, 865);
    			attr_dev(div1, "class", "expense-button");
    			add_location(div1, file$4, 26, 4, 683);
    			attr_dev(article, "class", "single-expense");
    			add_location(article, file$4, 15, 0, 347);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 27, 12, 763);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$1, 19, 12, 456);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "name");
    			add_location(input0, file$1, 20, 12, 499);
    			attr_dev(div0, "class", "form-control");
    			add_location(div0, file$1, 18, 8, 417);
    			attr_dev(label1, "for", "amount");
    			add_location(label1, file$1, 23, 12, 611);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "id", "amount");
    			add_location(input1, file$1, 24, 12, 658);
    			attr_dev(div1, "class", "form-control");
    			add_location(div1, file$1, 22, 8, 572);
    			attr_dev(button0, "type", "submit");
    			attr_dev(button0, "class", "btn btn-block");
    			button0.disabled = /*isEmpty*/ ctx[2];
    			toggle_class(button0, "disabled", /*isEmpty*/ ctx[2]);
    			add_location(button0, file$1, 31, 8, 873);
    			attr_dev(i, "class", "fas fa-times");
    			add_location(i, file$1, 35, 12, 1066);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "close-btn");
    			add_location(button1, file$1, 34, 9, 1013);
    			attr_dev(form, "class", "expense-form");
    			add_location(form, file$1, 17, 4, 341);
    			attr_dev(section, "class", "form");
    			add_location(section, file$1, 15, 0, 280);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 53, 4, 1530);
    			attr_dev(main, "class", "content");
    			add_location(main, file, 49, 0, 1393);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("expenses" in $$props) $$invalidate(0, expenses = $$props.expenses);
    		if ("setName" in $$props) setName = $$props.setName;
    		if ("setAmount" in $$props) setAmount = $$props.setAmount;
