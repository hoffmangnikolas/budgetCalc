...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$2, 19, 12, 508);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*displayAmount*/ ctx[4] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file$2, 15, 16, 400);
    			attr_dev(button0, "class", "amount-btn");
    			add_location(button0, file$2, 14, 19, 325);
    			add_location(h2, file$2, 13, 8, 301);
    			attr_dev(div0, "class", "expense-info");
    			add_location(div0, file$2, 12, 4, 266);
    			attr_dev(i1, "class", "fas fa-pen");
    			add_location(i1, file$2, 24, 12, 652);
    			attr_dev(button1, "class", "expense-btn edit-btn");
    			add_location(button1, file$2, 23, 8, 602);
    			attr_dev(i2, "class", "fas fa-trash");
    			add_location(i2, file$2, 27, 12, 792);
    			attr_dev(button2, "class", "expense-btn delete-btn");
    			add_location(button2, file$2, 26, 8, 705);
    			attr_dev(div1, "class", "expense-button");
    			add_location(div1, file$2, 22, 4, 565);
    			attr_dev(article, "class", "single-expense");
    			add_location(article, file$2, 11, 0, 229);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function toggleAmount() {
    		$$invalidate(4, displayAmount = !displayAmount);
    	}

    	const writable_props = ["id", "name", "amount", "removeExpense"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("removeExpense" in $$props) $$invalidate(3, removeExpense = $$props.removeExpense);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("amount" in $$props) $$invalidate(2, amount = $$props.amount);
    		if ("removeExpense" in $$props) $$invalidate(3, removeExpense = $$props.removeExpense);
    		if ("displayAmount" in $$props) $$invalidate(4, displayAmount = $$props.displayAmount);
    	};
    	...
    	return [id, name, amount, removeExpense, displayAmount, toggleAmount, click_handler];
    }
    ...
    class Expense extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*removeExpense*/ ctx[3] === undefined && !("removeExpense" in props)) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 21, 12, 462);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	let expense;
    	let current;
    	const expense_spread_levels = [/*expense*/ ctx[2], { removeExpense: /*removeExpense*/ ctx[1] }];
    	let expense_props = {};
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const expense_changes = (dirty & /*expenses, removeExpense*/ 3)
    			? get_spread_update(expense_spread_levels, [
    					dirty & /*expenses*/ 1 && get_spread_object(/*expense*/ ctx[2]),
    					dirty & /*removeExpense*/ 2 && { removeExpense: /*removeExpense*/ ctx[1] }
    				])
    			: {};
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$1, 17, 4, 329);
    			add_location(section, file$1, 15, 0, 273);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class ExpenseList extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*removeExpense*/ ctx[1] === undefined && !("removeExpense" in props)) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 15, 0, 514);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
