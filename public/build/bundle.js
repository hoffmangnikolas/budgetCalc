...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$5, 3, 8, 79);
    			attr_dev(i, "class", "far fa-plus-square");
    			add_location(i, file$5, 5, 12, 183);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "nav-btn");
    			add_location(button, file$5, 4, 8, 132);
    			attr_dev(div, "class", "nav-center");
    			add_location(div, file$5, 2, 4, 46);
    			attr_dev(nav, "class", "nav");
    			add_location(nav, file$5, 1, 0, 24);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h2 = element("h2");
    			t = text(/*title*/ ctx[0]);
    			add_location(h2, file$4, 8, 4, 184);
    			attr_dev(div, "class", "main-title");
    			add_location(div, file$4, 7, 0, 155);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src/Expense.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$3, 22, 12, 573);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file$3, 18, 16, 465);
    			attr_dev(button0, "class", "amount-btn");
    			add_location(button0, file$3, 17, 19, 390);
    			add_location(h2, file$3, 16, 8, 366);
    			attr_dev(div0, "class", "expense-info");
    			add_location(div0, file$3, 15, 4, 331);
    			attr_dev(i1, "class", "fas fa-pen");
    			add_location(i1, file$3, 27, 12, 717);
    			attr_dev(button1, "class", "expense-btn edit-btn");
    			add_location(button1, file$3, 26, 8, 667);
    			attr_dev(i2, "class", "fas fa-trash");
    			add_location(i2, file$3, 30, 12, 857);
    			attr_dev(button2, "class", "expense-btn delete-btn");
    			add_location(button2, file$3, 29, 8, 770);
    			attr_dev(div1, "class", "expense-button");
    			add_location(div1, file$3, 25, 4, 630);
    			attr_dev(article, "class", "single-expense");
    			add_location(article, file$3, 14, 0, 294);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Expense extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { id: 0, name: 1, amount: 2 });
    ...
    const file$2 = "src/ExpenseList.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$2, 21, 12, 421);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$2, 17, 4, 304);
    			add_location(section, file$2, 15, 0, 248);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$1 = "src/Totals.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(" : $");
    			t2 = text(/*total*/ ctx[1]);
    			add_location(h2, file$1, 6, 4, 119);
    			attr_dev(section, "class", "main-title");
    			add_location(section, file$1, 5, 0, 86);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Totals extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { title: 0, total: 1 });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 30, 4, 975);
    			attr_dev(main, "class", "content");
    			add_location(main, file, 27, 0, 871);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
