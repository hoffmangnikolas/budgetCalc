...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$1, 10, 12, 238);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "name");
    			add_location(input0, file$1, 11, 12, 281);
    			attr_dev(div0, "class", "form-control");
    			add_location(div0, file$1, 9, 8, 199);
    			attr_dev(label1, "for", "amount");
    			add_location(label1, file$1, 14, 12, 393);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "id", "amount");
    			add_location(input1, file$1, 15, 12, 440);
    			attr_dev(div1, "class", "form-control");
    			add_location(div1, file$1, 13, 8, 354);
    			attr_dev(p, "class", "form-empty");
    			add_location(p, file$1, 17, 8, 519);
    			attr_dev(button0, "type", "submit");
    			attr_dev(button0, "class", "btn btn-block");
    			add_location(button0, file$1, 20, 8, 607);
    			attr_dev(i, "class", "fas fa-times");
    			add_location(i, file$1, 24, 12, 756);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "close-btn");
    			add_location(button1, file$1, 23, 9, 703);
    			attr_dev(form, "class", "expense-form");
    			add_location(form, file$1, 8, 4, 163);
    			attr_dev(section, "class", "form");
    			add_location(section, file$1, 6, 0, 102);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [name, amount, input0_input_handler, input1_input_handler];
    }
