...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$1, 5, 12, 183);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "nav-btn");
    			add_location(button, file$1, 4, 8, 132);
    			attr_dev(div, "class", "nav-center");
    			add_location(div, file$1, 2, 4, 46);
    			attr_dev(nav, "class", "nav");
    			add_location(nav, file$1, 1, 0, 24);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h2 = element("h2");
    			h2.textContent = "add expense";
    			add_location(h2, file, 2, 4, 61);
    			attr_dev(div, "class", "main-title");
    			add_location(div, file, 1, 0, 32);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Navbar, Title });
    	return [];
    }
